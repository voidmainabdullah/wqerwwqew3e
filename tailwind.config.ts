...
export const AuthPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-background">
      ...
      <motion.div 
        className="absolute top-0 left-0 h-px bg-gradient-to-r from-transparent via-neutral-800 to-transparent z-10"
        initial={{ width: "0%" }}
        animate={{ width: "100%" }}
              ...
              <CardHeader className="text-center space-y-6 relative z-10">
                ...
                >
                  <div className="relative w-20 h-20 mx-auto">
                    ...
                    {/* Rotating glow ring */}
                    <motion.div
                      className={`absolute inset-0 rounded-xl border-2 ${actualTheme === 'light' ? 'border-neutral-800/50' : 'border-primary/30'}`}
                      animate={{ rotate: 360 }}
                    ...
                    {/* Pulsing glow */}
                    <motion.div
                      className={`absolute inset-0 rounded-full ${actualTheme === 'light' ? 'bg-neutral-800/20' : 'bg-primary/10'}`}
              ...
              <CardContent className="space-y-6 relative z-10">
                  ...
                  >
                    <Button
                      ...
                      className={`w-full h-14 text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl relative overflow-hidden group ${
                        actualTheme === 'light' 
                          ? 'bg-gradient-to-r from-neutral-800 to-black hover:from-neutral-700 hover:to-neutral-900 text-white hover:shadow-neutral-800/20' 
                    ...
                    >
                      ...
                      <div className={`absolute inset-0 bg-gradient-to-r from-transparent to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 ${
                        actualTheme === 'light' ? 'via-neutral-200/20' : 'via-neutral-200/10'
                      }`}></div>
                        ...
                        <div className="flex items-center gap-3">
                          <motion.div 
                            className={`w-5 h-5 border-2 border-t-transparent rounded-full ${
                              actualTheme === 'light' ? 'border-neutral-200' : 'border-primary-foreground'
                            }`}
                            animate={{ rotate: 360 }}
                ...
                >
                  ...
                  <div className="absolute top-2 right-2">
                    <motion.div
                      className={`w-2 h-2 rounded-full ${actualTheme === 'light' ? 'bg-neutral-800' : 'bg-neutral-400'}`}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    >
                      <Shield className={`h-6 w-6 flex-shrink-0 mt-1 ${actualTheme === 'light' ? 'text-neutral-800' : 'text-primary'}`} />
                    </motion.div>
                        ...
                        {[
                          ...
                          <motion.div
                            ...
                            className={`flex items-center gap-2 text-xs text-muted-foreground px-2 py-1 rounded-md ${
                              actualTheme === 'light' ? 'bg-neutral-100/80' : 'bg-background/50'
                            }`}
                            initial={{ opacity: 0, x: -10 }}
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.4, delay: 1.2 + index * 0.1 }}
                          >
                            <feature.icon className={`w-3 h-3 ${actualTheme === 'light' ? 'text-neutral-800' : 'text-primary'}`} />
      ...
      >
        <motion.path
          ...
          stroke={actualTheme === 'light' ? "rgba(38,38,38,0.3)" : "rgba(38,38,38,0.3)"}
          strokeWidth="2"
          fill="none"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
        ...
        <motion.path
          ...
          stroke={actualTheme === 'light' ? "rgba(38,38,38,0.2)" : "rgba(38,38,38,0.2)"}
          strokeWidth="1"
          fill="none"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
