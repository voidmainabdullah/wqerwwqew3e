          ...
          <BrowserRouter>
            <Suspense fallback={<PageLoader text="Loading..." />}>
              <Routes>
                ...
                <Route path="/dashboard/teams/manage" element={
                  <ProtectedRoute>
                    <TeamsPage />
                  </ProtectedRoute>
                } />
                <Route path="/dashboard/teams/receive" element={
                  <ProtectedRoute>
                    <ReceiveFilesPage />
                  </ProtectedRoute>
                } />
                <Route path="/dashboard/teams/share" element={
                  <ProtectedRoute>
                    <ShareFilesPage />
                  </ProtectedRoute>
                } />
                <Route path="/dashboard/teams/invites" element={
                  <ProtectedRoute>
                    <InvitesPage />
                  </ProtectedRoute>
                } />
                <Route path="/dashboard/teams/policies" element={
                  <ProtectedRoute>
                    <PoliciesPage />
                  </ProtectedRoute>
                } />
                <Route path="/dashboard/teams/audit" element={
                  <ProtectedRoute>
                    <AuditPage />
                  </ProtectedRoute>
                } />
                <Route path="/dashboard/teams/settings" element={
                  <ProtectedRoute>
                    <TeamSettingsPage />
                  </ProtectedRoute>
                } />
