      ...
      <div className="w-full max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 mx-0 my-[120px]">
        ...
        <div className="space-y-6 md:space-y-8 px-4 md:px-0">
          ...
          delay: 0.6
            ...
            <Button variant="default" className="border-2 border-neutral-300 bg-gray-600  hover:text-white dark:border-neutral-600 dark:hover: text-white md:text-lg h-12 md:h-14 px-6 md:px-8 rounded-xl font-semibold transition-all duration-300 w-full sm:w-auto" asChild>
              <a href="/auth">
              Go To Dashboard
              </a>
            </Button>
