      ...
      <div className="w-full max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 mx-0 my-[120px]">
        ...
        <div className="space-y-6 md:space-y-8 px-4 md:px-0">
          ...
          delay: 0.6
            ...
            <Button variant="default" className="text-base md:text-lg h-12 md:h-14 px-6 md:px-8 rounded-xl dark:bg-black/20 dark:text-white dark:hover:bg-white/50 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto" asChild>
              <a href="/auth">
                Get Started
              </a>
            </Button>
