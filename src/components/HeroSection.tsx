      ...
      <div className="w-full max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 mx-0 my-[120px]">
        ...
        <div className="space-y-6 md:space-y-8 px-4 md:px-0">
          ...
          >
            ...
            <Button
              variant="outline"
              className="border-2 text-base md:text-lg h-12 md:h-14 px-6 md:px-8 rounded-xl font-heading font-semibold transition-all duration-300 w-full sm:w-auto icon-text hover:scale-105"
              asChild
            >
              <a href="/dashboard">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs sm:text-sm font-body font-medium text-muted-foreground">
                AWS-256 Encryption
              </span>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            ...
            <div className="group bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/20 rounded-2xl p-4 hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600/70 dark:text-blue-400/70 font-body">
                    Military Grade
                  </p>
                </div>
              </div>
            ...
            <div className="group bg-gradient-to-br from-emerald-500/10 to-green-600/10 border border-emerald-500/20 rounded-2xl p-4 hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-105">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-sm font-heading font-bold text-emerald-700 dark:text-emerald-300">
                    Unlimited Bandwidth
                  </span>
                  <p className="text-xs text-emerald-600/70 dark:text-emerald-400/70 font-body">
                    No Limits
                  </p>
                </div>
              </div>
            ...
            <div className="group bg-gradient-to-br from-purple-500/10 to-violet-600/10 border border-purple-500/20 rounded-2xl p-4 hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 hover:scale-105">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <span className="material-icons md-24 text-purple-600 dark:text-purple-400">admin_panel_settings</span>
                </div>
                <div>
                  <span className="text-sm font-heading font-bold text-purple-700 dark:text-purple-300">
                    Full Access
                  </span>
                  <p className="text-xs text-purple-600/70 dark:text-purple-400/70 font-body">
                    Complete Control
                  </p>
                </div>
              </div>
            ...
            <div className="group bg-gradient-to-br from-amber-500/10 to-orange-600/10 border border-amber-500/20 rounded-2xl p-4 hover:shadow-lg hover:shadow-amber-500/25 transition-all duration-300 hover:scale-105">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-sm font-heading font-bold text-amber-700 dark:text-amber-300">
                    Lightning Fast
                  </span>
                  <p className="text-xs text-amber-600/70 dark:text-amber-400/70 font-body">
                    Instant Transfer
                  </p>
                </div>
              </div>
