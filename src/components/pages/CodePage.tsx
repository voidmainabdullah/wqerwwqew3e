      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="font-heading flex items-center justify-center gap-2">
            <span className="material-icons md-24">tag</span>
        ...
        <CardContent className="space-y-4">
          {!file ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={downloadFile} className="flex-1 font-heading icon-text">
                  <span className="material-icons md-18">download</span>
                  Download
                </Button>
                <Button variant="outline" onClick={resetForm} className="font-heading">
                  New Code
                </Button>
              </div>
            </div>
          ...
          <div className="text-center pt-4 border-t">
            <Button variant="link" asChild className="text-sm font-body icon-text">
              <a href="/">
