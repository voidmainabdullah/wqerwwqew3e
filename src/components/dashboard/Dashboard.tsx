...
`}
      ...
      <div className="p-8 space-y-8 bg-zinc-900">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Shares Card */}
          <Card className="bg-gradient-to-br from-zinc-600/20 to-neutral-400/10 border border-zinc-700/40  transition-all duration-300">
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <div>
                <CardTitle className="text-slate-400 text-sm font-medium uppercase tracking-wide">
                  Active Shares
          ...
          {/* Storage Card */}
          <Card className="bg-gradient-to-br from-indigo-600/60 to-blue-900/60 border border-zinc-700/40  hover:border-slate-500/50 transition-all duration-300">
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <div>
                <CardTitle className="text-slate-400 text-sm font-medium uppercase tracking-wide">
                  Storage Used
