...
<div className="flex flex-col md:flex-row gap-6 items-stretch justify-center w-full max-w-6xl mx-auto p-4">
  ...
  <div className="relative overflow-hidden  bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-850 rounded-3xl border border-neutral-800 shadow-2xl w-full md:w-2/3 group cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-gray-500/20 h-[300px]">
    ...
    <div className="absolute inset-0 overflow-hidden rounded-3xl">
      <iframe
        className="w-full h-80 object-cover scale-105 opacity-85 transition-all duration-500 group-hover:opacity-100"
...
`}
      ...
      <div className="p-8 space-y-8 bg-zinc-900">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {/* Files Card */}
          <Card className="bg-gradient-to-br  from-black to-blue-900/40 border border border-zinc-700/40 hover:border-slate-500/50 transition-all duration-300">
          ...
          {/* Shares Card */}
          <Card className="bg-gradient-to-br  from-black to-blue-900/40 border border border-zinc-700/40  transition-all duration-300">
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <div>
                <CardTitle className="text-slate-400 text-sm font-medium uppercase tracking-wide">
                  Active Shares
          ...
          {/* Storage Card */}
          <Card className="bg-gradient-to-br from-black to-blue-900/40 border border-zinc-700/40  hover:border-slate-500/50 transition-all duration-300">
            <CardHeader className="flex flex-row items-center justify-between pb-3">
              <div>
                <CardTitle className="text-slate-400 text-sm font-medium uppercase tracking-wide">
                  Storage Used
