          ...
          <div className="hidden lg:block">
            ...
            >
              <div className="relative overflow-hidden rounded-xl  border-primary shadow-lg 
                ...
                dark: bg-gradient-to-r from-neutral-900 via-neutral-700 to-neutral-900 
                p-6 shadow-xl border-r border-blue-600 rounded-xl p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          />
           ...
           <QuickActionCard
            title="Recieve File"
            description="Receive files instantly with advanced security and ease."
