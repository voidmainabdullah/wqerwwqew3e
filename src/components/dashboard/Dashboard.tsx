      ...
      <CardHeader className="flex flex-row items-center justify-between pb-3">
        <div>
          ...
          <div className="text-3xl font-bold text-white mt-2">
            {/* Safely access stats */}
            {stats?.totalFiles ? stats.totalFiles.toLocaleString() : 0}
          </div>
          <div className="flex items-center gap-2 mt-2">
            <div className="w-2 h-2 rounded-full bg-emerald-400"></div>
            <span className="text-emerald-400 text-sm">This Month: {stats?.thisMonthFiles || 0}</span>
          </div>
        </div>
    ...
    <Card className="bg-gradient-to-br from-neutral-800 to-neutral-900 border-slate-600/50 hover:border-slate-500/50 transition-all duration-300 hover:shadow-lg">
      <CardHeader className="flex flex-row items-center justify-between pb-3">
        <div>
          ...
          <div className="text-3xl font-bold text-white mt-2">
            {/* Safely access stats */}
            {stats?.totalShares ? stats.totalShares.toLocaleString() : 0}
          </div>
          <div className="flex items-center gap-2 mt-2">
    ...
    <Card className="bg-gradient-to-br from-neutral-800 to-neutral-900 border-slate-600/50 hover:border-slate-500/50 transition-all duration-300 hover:shadow-lg">
      <CardHeader className="flex flex-row items-center justify-between pb-3">
        <div>
          ...
          <div className="text-3xl font-bold text-white mt-2">
            {/* Safely access stats */}
            {stats?.totalDownloads ? stats.totalDownloads.toLocaleString() : 0}
          </div>
          <div className="flex items-center gap-2 mt-2">
            <div className="w-2 h-2 rounded-full bg-emerald-400"></div>
