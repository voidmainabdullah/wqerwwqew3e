      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="relative overflow-hidden">
          ...
          <CardContent className="bg-gradient-to-t from-blue-900 via-blue-800 bg-[#6bffa0]/5">
            ...
            <Button className="w-full bg-gradient-to-r from-green-600 to-black hover:from-blue/90 hover:to-black/90 text-white font-semibold py-2 px-4 rounded-lg transform transition hover:scale-105" asChild>
