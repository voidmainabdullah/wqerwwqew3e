          ...
          <div className="hidden lg:block">
            ...
            >
              <div className="relative overflow-hidden rounded-xl  border-primary shadow-lg 
                ...
                dark:bg-gradient-to-br from-neutral-800 via-neutral-800 to-yellow-200/30 p-4 shadow-sm rounded-xl">
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center text-gray-200 text-sm font-medium bg-white text-black rounded-xl">
