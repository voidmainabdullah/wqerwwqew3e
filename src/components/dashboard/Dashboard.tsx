          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gradient-to-br from-neutral-900 to-slate-600 border-slate-600/50">
              ...
              <CardContent className="space-y-4">
                ...
                {!isPro && <Button asChild className="w-full bg-gradient-to-br from-blue-600 to-blue-400 text-white hover:  bg-gradient-to-br from-blue-600 to-blue-40 text-white border-0">
