...
export const Dashboard: React.FC = () => {
  ...
  <div className="w-full border-b border-neutral-800 bg-neutral-950/8 backdrop-blur-md rounded-t-xl">  
    <div className="w-full border border-[#ffffff10] rounded-none bg-gradient-to-r from-blue-800/20 via-stone-950 to-stone-950 py-2 sm:py-[8px] px-3  sm:px-6 md:px-6 -mt-8">  
