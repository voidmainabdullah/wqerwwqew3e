          ...
          <div className="hidden lg:block">
            ...
            >
              <div className="relative overflow-hidden rounded-xl  border-primary shadow-lg 
                bg-gradient-to-r from-black via-neutral-900 to-blue-500  border-r border-blue-500 rounded-xl p-4  dark:bg-white p-6 shadow-xl border-r border-blue-600 rounded-xl p-4">
