  ...
  return (
    <div className="space-y-8">
          ...
          <div className="hidden lg:block">
            ...
            >
              <div className="relative overflow-hidden rounded-xl  shadow-lg 
                  rounded-xl p-4 bg-gradient-to-br from-neutral-800 via-neutral-800 to-yellow-200/40 p-4 shadow-sm rounded-xl">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Storage */}
        <Card className="relative overflow-hidden  shadow-sm hover:shadow-xl transition-all duration-300 group 0 rounded-xl ">
