...
const AppSidebar = () => {
  ...
  asChild
  tooltip="Upgrade"
  className="h-9 px-3 rounded-lg bg-accent/10  border text-neutral-200 hover:bg-accent/10 transition-all duration-200 group-data-[collapsible=icon]:justify-center"
>
