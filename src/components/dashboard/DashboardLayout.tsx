        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="border-b border-border/60 bg-background/95 backdrop-blur-xl sticky top-0 z-40 shadow-sm">
            <div className="flex items-center justify-between h-16 px-4 md:px-6 bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800">
              ...
              <div className="flex items-center gap-2">
                {/* Navbar Icons Group */}
                <div className="flex items-center gap-1 relative bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800 before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.07),transparent_60%)] before:pointer-events-none">
                  <NotificationPopover />
                  <StoragePopover />
                  <HelpPopover />
