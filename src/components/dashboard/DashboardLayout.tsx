...
const AppSidebar = () => {
  ...
  asChild
  tooltip="Upgrade"
  className="h-9 px-3 rounded-lg bg-neutral-600/60 text-purple-200/30 hover:bg-accent/10 transition-all duration-200 group-data-[collapsible=icon]:justify-center"
>
