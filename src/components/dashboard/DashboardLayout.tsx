...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  const StoragePopover = () => <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="icon" className="relative h-9 w-40 rounded-full  bg-gradient-to-br from-zinc-950 via-zinc-900 to-indigo-800 hover:bg-zinc-700 transition-colors">
