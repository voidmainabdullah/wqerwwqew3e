...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  const StoragePopover = () => <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="icon" className="relative h-9 w-40 rounded-full  bg-zinc-800 hover:bg-accent transition-colors">
...
"
  ...
  >
    <a href="#" className="flex items-center gap-2 text-black no-underline">
      <Crown
        className="h-4 w-4 fill-white text-amber-400 transition-all duration-300 group-hover:scale-110"
        weight="duotone"
      />
