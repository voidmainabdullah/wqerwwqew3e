...
const Header = () => {
  ...
  return <motion.div className={`fixed top-0 left-0 right-0 z-50 pt-2 px-4 transition-all duration-300 ${isScrolled ? 'backdrop-blur-xl bg-background/90 shadow-lg' : 'bg-transparent'}`}>
      <header className="w-full max-w-7xl mx-auto py-2 px-6 md:px-8 flex items-center justify-between max-h-10 ">
        <div className="p-3">
          <motion.div initial={{
          opacity: 0,
          x: -20
        ...
        {mobileMenuOpen && <div className="md:hidden absolute top-16 left-4 right-4 bg-background/95 backdrop-blur-md py-3 px-4 border border-border rounded-xl shadow-lg z-50">
            <div className="flex flex-col gap-2">
              ...
              <div className="border-t border-border pt-3 mt-3 space-y-2">
                <Button variant="ghost" className="w-full h-10 bg-neutral-700 text-slate-250 font-medium text-sm justify-center">
                  Log in
                </Button>
                <Button variant="ghost" className="w-full h-10 bg-white text-slate-950 font-medium text-sm justify-center">
                  Get Started
                </Button>
              </div>
            </div>
  ...
  <div className="flex gap-3 rounded-xl"> 
    <Button variant="ghost" className="h-8 px-4 bg-neutral-700 text-slate-250 font-medium text-sm text-left">
      Log in
    </Button>
    <Button variant="ghost" className="h-8 px-3 bg-white text-slate-950 font-medium text-sm text-left">
      Get Started
    </Button>
  </div>
</div>
