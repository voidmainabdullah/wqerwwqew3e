      ...
      <div className="space-y-6">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-white">Team Invitations</h1>
              <p className="text-gray-400 text-sm md:text-base">
                Manage team member invitations and requests
              </p>
            </div>
          </div>
        </div>
        ...
        <Card className="bg-stone-900/50 border-white/10 backdrop-blur-sm p-6">
          {teamId ? (
            <TeamInvitesManager teamId={teamId} />
          ) : (
            <div className="text-center py-12">
              <p className="text-gray-400 text-lg">Please select a team to manage invitations</p>
            </div>
          )}
        </Card>
      </div>
