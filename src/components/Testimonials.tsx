...
const Testimonials = () => {
  const testimonials = [
    ...
    {
      quote:
        "From design to performance, everything about SkyShare feels premium — we use it every single day.",
      author: "Amira Patel",
    ...
    {
      quote:
        "Our global team loves how intuitive SkyShare feels — even complex workflows are simple now.",
      author: "Kenji Sato",
