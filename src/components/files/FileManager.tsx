      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-2  rounded-xl bg-neutral-400 text-gray-300 focus:outline-none focus:ring-2 focus:ring-black dark:bg-neutral-600 dark:text-white dark:focus:ring-neutral-800"
          >
