      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-300 rounded-xl bg-neutral-600 text-black focus:outline-none focus:ring-2 focus:ring-black dark:bg-neutral-600 dark:text-white dark:focus:ring-neutral-800/10"
          >
